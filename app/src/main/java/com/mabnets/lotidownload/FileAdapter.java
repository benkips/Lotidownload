...
public class FileAdapter extends RecyclerView.Adapter<FileAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        if (downloadData.eta == -1) {
            ...
            holder.timeRemainingTextView.setText(com.mabnets.lotidownload.Utils.getETAString(context, downloadData.eta));
        }

        if (downloadData.downloadedBytesPerSecond == 0) {
            holder.downloadedBytesPerSecondTextView.setText("");
        } else {
            holder.downloadedBytesPerSecondTextView.setText(com.mabnets.lotidownload.Utils.getDownloadSpeedString(context, downloadData.downloadedBytesPerSecond));
        }
        ...
        switch (status) {
            case COMPLETED: {
                ...
                holder.actionButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    share.setDataAndType(uri1, com.mabnets.lotidownload.Utils.getMimeType(context, uri1));
            ...
            case PAUSED: {
                holder.actionButton.setText("Resume");
                holder.actionButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        holder.actionButton.setEnabled(false);
            ...
            case DOWNLOADING:
            case QUEUED: {
                holder.actionButton.setText("Pause");
                holder.actionButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        holder.actionButton.setEnabled(false);
